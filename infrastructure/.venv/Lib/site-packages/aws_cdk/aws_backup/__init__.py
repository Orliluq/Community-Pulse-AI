    ...
    class NotificationObjectTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param sns_topic_arn: An ARN that uniquely identifies an Amazon Simple Notification Service (Amazon SNS) topic; for example, ``arn:aws:sns:us-east-2:111122223333:MyTopic`` .
        ...
        def sns_topic_arn(self) -> builtins.str:
            ...
            for example, ``arn:aws:sns:us-east-2:111122223333:MyTopic`` .
...
class CfnBackupVaultProps:
    ...
    def encryption_key_arn(
        ...
        for example, ``arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab`` . If you specify a key, you must specify its ARN, not its alias. If you do not specify a key, AWS Backup creates a KMS key for you by default.
    ...
    class NotificationObjectTypeProperty:
        def __init__(
            ...
            *,
            ...
            :param sns_topic_arn: The Amazon Resource Name (ARN) that specifies the topic for a backup vault’s events; for example, ``arn:aws:sns:us-east-2:111122223333:MyVaultTopic`` .
        ...
        def sns_topic_arn(self) -> builtins.str:
            ...
            for example, ``arn:aws:sns:us-east-2:111122223333:MyVaultTopic`` .
...
class CfnLogicallyAirGappedBackupVaultProps:
    ...
    @builtins.property
    def encryption_key_arn(self) -> typing.Optional[builtins.str]:
        '''The server-side encryption key that is used to protect your backups; for example, ``arn:aws:kms:us-east-2:111122223333:key/1234abcd-12ab-34cd-56ef-1234567890ab`` .
    ...
    class ReportDeliveryChannelProperty:
        def __init__(
            ...
            *,
            ...
            :param s3_key_prefix: The prefix for where AWS Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/ ``prefix`` /Backup/us-east-2/year/month/day/report-name. If not specified, there is no prefix.
        ...
        def s3_key_prefix(self) -> typing.Optional[builtins.str]:
            ...
            The prefix is this part of the following path: s3://your-bucket-name/ ``prefix`` /Backup/us-east-2/year/month/day/report-name. If not specified, there is no prefix.
    ...
    class RestoreTestingRecoveryPointSelectionProperty:
        def __init__(
            ...
            *,
            ...
            :param include_vaults: Accepted values include wildcard ["*"] or by specific ARNs or ARN wilcard replacement ["arn:aws:backup:us-east-2:123456789012:backup-vault:asdf", ...] ["arn:aws:backup:*:*:backup-vault:asdf-*", ...].
        ...
        def include_vaults(self) -> typing.List[builtins.str]:
            '''Accepted values include wildcard ["*"] or by specific ARNs or ARN wilcard replacement ["arn:aws:backup:us-east-2:123456789012:backup-vault:asdf", ...] ["arn:aws:backup:*:*:backup-vault:asdf-*", ...].
