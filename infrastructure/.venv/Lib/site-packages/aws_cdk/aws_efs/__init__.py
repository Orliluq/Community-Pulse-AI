...
efs.FileSystem(self, "RegionalReplicationFileSystem",
    vpc=vpc,
    replication_configuration=efs.ReplicationConfiguration.regional_file_system("us-east-2")
)
...
class CfnFileSystem(
    ...
    def attr_arn(self) -> builtins.str:
        ...
        Example: ``arn:aws:elasticfilesystem:us-east-2:1111333322228888:file-system/fs-0123456789abcdef8``
...
class CfnFileSystemProps:
    ...
    def kms_key_id(
        ...
        - Key alias ARN - An ARN for a key alias, for example ``arn:aws:kms:us-east-2:444455556666:alias/projectKey1`` .
