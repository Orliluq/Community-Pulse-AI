...
class CfnLoggingConfiguration(
    ...
    def attr_arn(self) -> builtins.str:
        ...
        For example: ``arn:aws:ivschat:us-east-2:123456789012:logging-configuration/abcdABCDefgh``
...
class CfnRoom(
    ...
    def attr_arn(self) -> builtins.str:
        ...
        For example: ``arn:aws:ivschat:us-east-2:123456789012:room/abcdABCDefgh``
