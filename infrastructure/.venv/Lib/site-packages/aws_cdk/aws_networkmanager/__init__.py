...
class CfnTransitGatewayRouteTableAttachment(
    ...
    def __init__(
        ...
        *,
        ...
        :param transit_gateway_route_table_arn: The ARN of the transit gateway attachment route table. For example, ``"TransitGatewayRouteTableArn": "arn:aws:ec2:us-east-2:123456789012:transit-gateway-route-table/tgw-rtb-9876543210123456"`` .
        :param network_function_group_name: The name of the network function group.
        :param proposed_network_function_group_change: Describes proposed changes to a network function group.
...
class CfnTransitGatewayRouteTableAttachmentProps:
    ...
    def transit_gateway_route_table_arn(self) -> builtins.str:
        ...
        For example, ``"TransitGatewayRouteTableArn": "arn:aws:ec2:us-east-2:123456789012:transit-gateway-route-table/tgw-rtb-9876543210123456"`` .
