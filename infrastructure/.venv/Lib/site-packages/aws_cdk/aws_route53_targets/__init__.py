...
For example, if the Amazon-provided DNS for the load balancer is `ALB-xxxxxxx.us-east-2.elb.amazonaws.com`, CDK will create alias target in Route 53 will be `dualstack.ALB-xxxxxxx.us-east-2.elb.amazonaws.com`.
