...
class VpcSubnet:
    def __init__(
        ...
        *,
        ...
        :param availability_zone: (deprecated) The code of the availability zone this subnet is in (for example, 'us-east-2a').
    ...
    def availability_zone(self) -> builtins.str:
        '''(deprecated) The code of the availability zone this subnet is in (for example, 'us-east-2a').
